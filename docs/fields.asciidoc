...
--
This document describes the fields that are exported by Tuxbeat. They are
...
*`Print Service.Current Priority`*::
+
--
type: short
...
*`Print Service.Current Trantime`*::
+
--
type: short
...
*`Print Service.Current Blocktime`*::
+
--
type: short
...
*`Print Service.Current BUFTYPECONV`*::
+
--
type: short
